# Pixel Memory Game - Portfolio project 2
...
* To provide an easy, understandable interactive experience for the use to navigate through the game page, access social links and initate the game functions.
